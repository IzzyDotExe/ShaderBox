...
var require_command = __commonJS({
  "node_modules/commander/lib/command.js"(exports) {
    ...
    var childProcess2 = require_child_process();
      ...
      _executeSubCommand(subcommand, args) {
        ...
        if (process11.platform !== "win32") {
          if (launchWithNode) {
            ...
            proc = childProcess2.spawn(process11.argv[0], args, { stdio: "inherit" });
          } else {
          ...
          args.unshift(executableFile);
          args = incrementNodeInspectorPort(process11.execArgv).concat(args);
          proc = childProcess2.spawn(process11.execPath, args, { stdio: "inherit" });
        }
        if (!proc.killed) {
...
var require_merge_stream = __commonJS({
  "node_modules/merge-stream/index.js"(exports, module) {
    "use strict";
    var { PassThrough: PassThrough3 } = require_stream();
    module.exports = function() {
      var sources = [];
...
var require_stream_readable = __commonJS({
  "node_modules/readable-stream/lib/_stream_readable.js"(exports, module) {
    ...
    var from;
    require_inherits_browser()(Readable, Stream3);
    var errorOrDestroy = destroyImpl.errorOrDestroy;
...
var require_stream_passthrough = __commonJS({
  "node_modules/readable-stream/lib/_stream_passthrough.js"(exports, module) {
    ...
    require_inherits_browser()(PassThrough3, Transform);
  ...
  "node_modules/bl/BufferList.js"(exports, module) {
    ...
    BufferList.prototype.copy = function copy(dst, dstStart, srcStart, srcEnd) {
      ...
      if (srcStart === 0 && srcEnd === this.length) {
        if (!copy2) {
          return this._bufs.length === 1 ? this._bufs[0] : Buffer6.concat(this._bufs, this.length);
        }
        for (let i = 0; i < this._bufs.length; i++) {
    ...
    BufferList.prototype.append = function append(buf) {
      ...
      if (buf.buffer) {
        this._appendBuffer(Buffer6.from(buf.buffer, buf.byteOffset, buf.byteLength));
        ...
        this._appendBuffer(Buffer6.from(buf));
      }
      return this;
    };
    ...
    BufferList.prototype.indexOf = function(search, offset, encoding) {
      ...
      if (typeof search === "function" || Array.isArray(search)) {
        ...
        search = Buffer6.from([search]);
      } else if (typeof search === "string") {
        search = Buffer6.from(search, encoding);
      } else if (this._isBufferList(search)) {
        search = search.slice();
      } else if (Array.isArray(search.buffer)) {
        search = Buffer6.from(search.buffer, search.byteOffset, search.byteLength);
      } else if (!Buffer6.isBuffer(search)) {
        search = Buffer6.from(search);
      }
...
var require_readline = __commonJS({
  "browser-external:readline"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "readline" has been externalized for browser compatibility. Cannot access "readline.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
        }
      }
    }));
  }
...
var require_prompt = __commonJS({
  "node_modules/prompts/dist/elements/prompt.js"(exports, module) {
    "use strict";
    var readline2 = require_readline();
...
var require_legacy_streams = __commonJS({
  "node_modules/graceful-fs/legacy-streams.js"(exports, module) {
    var Stream3 = require_stream().Stream;
    ...
    if (!fs3[gracefulQueue]) {
      ...
      if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || "")) {
        process.on("exit", function() {
          ...
          require_assert().equal(fs3[gracefulQueue].length, 0);
        });
      }
    }
    var queue;
...
var import_node_child_process3 = __toESM(require_node_child_process());
...
var import_node_child_process2 = __toESM(require_node_child_process(), 1);
...
var import_node_process9 = __toESM(require_node_process());
...
var import_onetime2 = __toESM(require_onetime());
...
var restoreCursor = (0, import_onetime2.default)(() => {
  (0, import_signal_exit2.default)(() => {
    import_node_process5.default.stderr.write("\x1B[?25h");
  }, { alwaysLast: true });
});
...
var StdinDiscarder = class {
  constructor() {
    ...
    __privateAdd(this, _ourEmit);
    __privateAdd(this, _rl);
    __privateGet(this, _mutedStream).pipe(import_node_process8.default.stdout);
    const self2 = this;
    __privateSet(this, _ourEmit, function(event, data, ...arguments_) {
      const { stdin } = import_node_process8.default;
      if (__privateGet(self2, _requests) > 0 || stdin.emit === __privateGet(self2, _ourEmit)) {
        if (event === "keypress") {
          return;
        }
        if (event === "data" && data.includes(ASCII_ETX_CODE)) {
          import_node_process8.default.emit("SIGINT");
        }
        Reflect.apply(__privateGet(self2, _ourEmit), this, [event, data, ...arguments_]);
      } else {
        Reflect.apply(import_node_process8.default.stdin.emit, this, [event, data, ...arguments_]);
      }
    });
  }
  start() {
  ...
  _realStart() {
    ...
    __privateSet(this, _rl, import_node_readline.default.createInterface({
      input: import_node_process8.default.stdin,
      output: __privateGet(this, _mutedStream)
    }));
    __privateGet(this, _rl).on("SIGINT", () => {
      if (import_node_process8.default.listenerCount("SIGINT") === 0) {
        import_node_process8.default.emit("SIGINT");
      } else {
        __privateGet(this, _rl).close();
        import_node_process8.default.kill(import_node_process8.default.pid, "SIGINT");
      }
    });
  }
  _realStop() {
...
var Ora = class {
  constructor(options) {
    ...
    __privateSet(this, _options, {
      color: "cyan",
      stream: import_node_process9.default.stderr,
      discardStdin: true,
      hideCursor: true,
      ...options
    });
    ...
    if (import_node_process9.default.env.NODE_ENV === "test") {
...
`);
    ...
    if (__privateGet(this, _options).discardStdin && import_node_process9.default.stdin.isTTY) {
  ...
  stop() {
    ...
    if (__privateGet(this, _options).discardStdin && import_node_process9.default.stdin.isTTY && __privateGet(this, _isDiscardingStdin)) {
  ...
  stopAndPersist(options = {}) {
    ...
    const suffixText = options.suffixText !== void 0 ? options.suffixText : __privateGet(this, _suffixText);
...
var import_node_buffer4 = __toESM(require_node_buffer());
...
var import_node_buffer3 = __toESM(require_node_buffer(), 1);
...
var Body = class {
  ...
  async formData() {
    ...
    const { toFormData } = await import("./multipart-parser-2UU6CB42.js");
...
var extractContentType = (body, request) => {
  ...
  if (import_node_buffer3.Buffer.isBuffer(body) || import_node_util2.types.isAnyArrayBuffer(body) || ArrayBuffer.isView(body)) {
    return null;
  }
...
var import_node_util4 = __toESM(require_node_util(), 1);
...
var componentSchema = objectType({
  name: stringType(),
...
var componentsSchema = arrayType(componentSchema);
...
function getPackageInfo() {
  const packageJsonPath = import_path2.default.join("package.json");
  return import_fs_extra.default.readJSONSync(packageJsonPath);
}
...
var logger = {
  ...
  info(...args) {
    console.log(source_default.cyan(...args));
  },
  success(...args) {
...
async function main() {
  ...
  const program2 = new Command().name("@shadcn/ui").description("Add @shadcn/ui components to your project").version(
    packageInfo.version || "1.0.0",
    "-v, --version",
    "display the version number"
  );
  program2.command("add").description("add components to your project").action(async () => {
    var _a;
    logger.warn(
    ...
    if (!(components == null ? void 0 : components.length)) {
      logger.warn("No components selected. Nothing to install.");
      process.exit(0);
    }
    const destinationDir = import_path.default.resolve(dir);
    if (!(0, import_fs.existsSync)(destinationDir)) {
    ...
    for (const component of components) {
      ...
      for (const file of component.files) {
        const filePath = import_path.default.resolve(dir, file.name);
        await import_fs.promises.writeFile(filePath, file.content);
      }
...
async function promptForAddOptions() {
  ...
  if (!(availableComponents == null ? void 0 : availableComponents.length)) {
    logger.error(
...
*/
//# sourceMappingURL=@shadcn_ui.js.map
