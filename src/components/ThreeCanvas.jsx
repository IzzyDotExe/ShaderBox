...
const ThreeCanvas = ({ shape, vertexShader, fragmentShader }) => {
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            uniformsRef.current.uDelta.value = clock.getDelta();

            // Update resolution uniform each frame
            ...
            if (meshRef.current) {
                ...
                uniformsRef.current.uNormalMatrix.value.getNormalMatrix(meshRef.current.matrixWorld);
            }
            ...
            if (cam) {
                ...
                // Update view/projection matrices and camera position
                uniformsRef.current.uViewMatrix.value.copy(cam.matrixWorldInverse);
                uniformsRef.current.uProjectionMatrix.value.copy(cam.projectionMatrix);
                uniformsRef.current.uCameraPosition.value.setFromMatrixPosition(cam.matrixWorld);
            }
